...
function ChangePasswordScreen({ navigation }) {
  ...
  // // VALIDATE CURRENT PASSOWRD
  // const validateCurrentPasswordField = () => {
  //   const isValidField = Utility.isValidField(currentPassword);
  //   isValidField
  ...
  //   const isValidField = Utility.isValidField(newPassword);
  //   isValidField
  //     ? setNewPasswordError("")
  ...
  //   const isValidField = Utility.isValidField(confirmNewPassword);
  //   isValidField
