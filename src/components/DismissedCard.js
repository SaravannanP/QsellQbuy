...
function DismissedCard({ item, onPress }) {
    ...
    <TouchableOpacity onPress={onPress}>
      <View style={styles.card}>
        ...
        <View style={styles.cardInfo}>
          ...
          <Text> Amount Reimbursed: ${item.productDiscountedPrice}</Text>
          <Text> Date: {dayjs(item.endDate).format("DD/MM/YYYY",{timeZone: "Asia/Singapore",})}</Text>
